...
DebugRoomMenu_PokemonGet_Page1Values:
	...
	paged_value wDebugRoomMonMoves+0,       1,   NUM_ATTACKS, FREEZE_DRY,     DebugRoom_BoxStructStrings.Move1,     DebugRoom_PrintMoveName,    FALSE
	paged_value wDebugRoomMonMoves+1,       1,   NUM_ATTACKS, FREEZE_DRY,     DebugRoom_BoxStructStrings.Move2,     DebugRoom_PrintMoveName,    FALSE
	paged_value wDebugRoomMonMoves+2,       1,   NUM_ATTACKS, FREEZE_DRY,     DebugRoom_BoxStructStrings.Move3,     DebugRoom_PrintMoveName,    FALSE
	paged_value wDebugRoomMonMoves+3,       1,   NUM_ATTACKS, FREEZE_DRY,     DebugRoom_BoxStructStrings.Move4,     DebugRoom_PrintMoveName,    FALSE
