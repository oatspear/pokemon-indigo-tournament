...
.ok
	...
	ld a, [hl]
	dec a
	and SPIKES_LAYER_MASK ; 0 < a <= 3 at this point
	jr z, .one_layer
	dec a
	and a
	jr z, .two_layers
...
.UpdateDVs:
; Hard-coded 15 DVs in everything
	ld hl, wEnemyMonDVs
	ld a, $ff
	ld [hli], a
	ld [hl], a
...
; Give EVs
;   not needed
;   https://github.com/pret/pokecrystal/wiki/Replace-stat-experience-with-EVs
.evs_done
	xor a
	ldh [hMultiplicand + 0], a
	ldh [hMultiplicand + 1], a
