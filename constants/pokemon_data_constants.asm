...
; EV related flags
HP_EV_F     EQU 1 << HP_EV_BIT
ATK_EV_F    EQU 1 << ATK_EV_BIT
DEF_EV_F    EQU 1 << DEF_EV_BIT
SPD_EV_F    EQU 1 << SPD_EV_BIT
SP_ATK_EV_F EQU 1 << SP_ATK_EV_BIT
SP_DEF_EV_F EQU 1 << SP_DEF_EV_BIT
