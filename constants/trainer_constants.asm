...
KRIS EQU __trainer_class__
	...
	trainerclass GIOVANNI ; a
	const GIOVANNI1

	trainerclass GREEN ; 43
	const GREEN1
...
OFFSET_JOHTO_CLASSES EQU 0
OFFSET_KANTO_CLASSES EQU 8
OFFSET_ELITE_CLASSES EQU 16
TRAINER_CLASS_BIT_MASK EQU $1f ; for all classes
CLASS_OFFSET_BIT_MASK EQU 7 ; without considering regions

TRAINER_SET_TEAM1 EQU $0
TRAINER_SET_TEAM2 EQU $20
TRAINER_SET_TEAM3 EQU $40
TRAINER_SET_TEAM4 EQU $60
TRAINER_TEAM_BIT_MASK EQU $60
