...
ENDM
	...
	const checklosersbracket_command ; $a9
MACRO checklosersbracket
	db checklosersbracket_command
ENDM

	const checkplayermatch_command ; $aa
MACRO checkplayermatch
	db checkplayermatch_command
ENDM

	const checkplayerfirst_command ; $ab
MACRO checkplayerfirst
