...
wPlayerHazardLayers:: db
; only used for spikes or toxic spikes
; low nibble: spike layers
; high nibble: toxic spike layers
wEnemyHazardLayers:: db
; see above
	ds 1
...
; helper variable to store current round
wTPTRound:: db
