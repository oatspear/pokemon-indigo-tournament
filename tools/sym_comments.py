...
"""
Usage: ./sym_comments.py file.asm [indigo.sym] > file_commented.asm
...
if len(sys.argv) != 2 and len(sys.argv) != 3:
	print('Usage: %s file.asm [indigo.sym] > file_commented.asm' % sys.argv[0], file=sys.stderr)

wram_name = sys.argv[1]
sym_name = sys.argv[2] if len(sys.argv) == 3 else 'indigo.sym'
