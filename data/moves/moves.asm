...
; entries correspond to constants/move_constants.asm
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,         60, FIGHTING,      PHYSICAL, 100, 20,  30
	...
	move AROMATHERAPY, EFFECT_HEAL_BELL,           0, GRASS,         STATUS,   100,  5,   0
	...
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         70, GRASS,         PHYSICAL, 100, 15,   0
	...
	move LUNGE,        EFFECT_ATTACK_DOWN_HIT,    80, BUG,           PHYSICAL, 100, 15, 100
	...
	move VOLT_SWITCH,  EFFECT_HIT_AND_SWITCH,     70, ELECTRIC,      SPECIAL,  100, 20,   0
	...
	move MIMIC,        EFFECT_MIMIC,               0, NORMAL,        STATUS,     0, 10,   0
	...
	move BIDE,         EFFECT_BIDE,                0, NORMAL,        PHYSICAL,   0, 10,   0
	...
	move MIND_READER,  EFFECT_LOCK_ON,             0, NORMAL,        STATUS,     0,  5,   0
	...
	move FROST_BREATH, EFFECT_NORMAL_HIT,         65, ICE,           SPECIAL,  100, 10,   0
	...
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,        STATUS,     0,  5,   0
