...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite KarenSpriteGFX, 12, STANDING_SPRITE, PAL_OW_BLUE ; PAL_OW_RED
	...
	overworld_sprite SurgeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN ; PAL_OW_BROWN
	...
	overworld_sprite ClerkSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN          ; FIXME ROCKET
	overworld_sprite NurseSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN      ; FIXME ROCKET
