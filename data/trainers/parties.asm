...
GreenGroup:
	; TESTER (1)
	db "TESTER 1@"
	db DEWGONG,  LEFTOVERS, SNOW_WARNING,    0, RAIN_DANCE, SURF, FREEZE_DRY, FLIP_TURN
	db BAYLEEF,  LEFTOVERS, DROUGHT,   0, RAZOR_LEAF, BODY_SLAM, EARTHQUAKE, REFLECT
	db QUILAVA,  LEFTOVERS, DROUGHT,   0, OVERHEAT, QUICK_ATTACK, DIG, WILL_O_WISP
	db CROCONAW, LEFTOVERS, DRIZZLE, 0, WATERFALL, SLASH, NIGHT_SLASH, FLIP_TURN
	db JOLTEON,  LEFTOVERS, DRIZZLE,  0, THUNDER, VOLT_SWITCH, THUNDER_WAVE, U_TURN
	db HAUNTER,  LEFTOVERS, SAND_STREAM,     0, SHADOW_BALL, NASTY_PLOT, FROST_BREATH, THUNDERBOLT
	db -1 ; end
