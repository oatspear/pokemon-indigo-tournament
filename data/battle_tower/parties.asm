...
; BattleTowerMons group 1
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, BODY_SLAM, ICY_WIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, FREEZE_DRY, ICY_WIND, STRENGTH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SURF, RAIN_DANCE, WILD_CHARGE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, BODY_SLAM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
