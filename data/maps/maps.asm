...
MapGroup_Tournament:
	map TournamentLobby, TILESET_RADIO_TOWER, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_POKEMON_TALK, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map TournamentStadium, TILESET_BATTLE_TOWER_INSIDE, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_NONE
